...
public class HttpResponse {
    ...
    boolean text = false;//used to determine if data being sent back is a string or image
    /* Body of reply */
	...
	try {
		...
		if (line.contains("Content-Type: text") || line.contains("Content-type: text")){//if the line contains text, it will set the text variable as true
			text = true;
		}
